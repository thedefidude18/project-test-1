  ...
  return (
    ...
    >
      <svg width="80" height="80" viewBox="0 0 80 80">
        ...
        {/* Rocket body */}
        <ellipse cx="40" cy="40" rx="8" ry="20" fill="url(#rocketGradient)" />
        
        {/* Rocket tip */}
        <path d="M 40 20 L 35 30 L 45 30 Z" fill="hsl(var(--primary))" />
        
        {/* Rocket fins */}
        <path d="M 32 50 L 28 60 L 35 55 Z" fill="hsl(var(--primary) / 0.8)" />
        <path d="M 48 50 L 52 60 L 45 55 Z" fill="hsl(var(--primary) / 0.8)" />
        
        {/* Rocket window */}
        <circle cx="40" cy="35" r="4" fill="white" />
        
        {/* Character face in window */}
        <circle cx="38.5" cy="33.5" r="1" fill="black" />
        <circle cx="41.5" cy="33.5" r="1" fill="black" />
        <path d="M 37 36 Q 40 37 43 36" stroke="black" strokeWidth="0.5" fill="none" strokeLinecap="round" />
